...
// custom variables
var length_hidden_link = 750,
    length_link_between_hidden_nodes = 30,
    length_link_between_visible_nodes = 60,
    length_link_between_hidden_visible_nodes = 2,
    length_link_between_cluster_nodes = 1;
...
function draw_hidden_graph(graph) {
    ...
    var link = svg.append("g")
        ...
        .style("stroke-opacity", function (d) {
            if (d.isHidden || d.isCluster) return 0;
            else return 1;
        });
